function [pE,pC] = spm_dcm_neural_priors_szpropagation(model)
...
switch lower(model)
    ...
    case{'isi_cmc1d'}
        ...
        % prior moments on parameters
        %------------------------------------------------------------------
        [pE,pC] = spm_erp_priors_ISI_CMC1D;   
    ...
    case{'t12_cmcperturb'}
        ...
        % prior moments on parameters
        %------------------------------------------------------------------
        [pE,pC] = spm_erp_priors_T12_CMCperturb; 
        %[pE,pC] = spm_erp_priors_ISI;
    ...
    case{'szpropagation'}
        ...
        % prior moments on parameters
        %------------------------------------------------------------------
        [pE,pC] = spm_erp_priors_szpropagation; 
        %[pE,pC] = spm_erp_priors_ISI;
