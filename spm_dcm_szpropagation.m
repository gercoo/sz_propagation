function DCM = spm_dcm_szpropagation(DCM)
...
%--------------------------------------------------------------------------
[pE,pC] = spm_L_priors_T12_CMCperturb(DCM.M.dipfit,pE,pC);
...
% create DCM
%--------------------------------------------------------------------------
DCM.M.IS = 'spm_csd_mtf_T12_CMCperturb';
DCM.M.g  = 'spm_gx_erp';
% DCM.M.f  = f;
% DCM.M.x  = x;
...
%--------------------------------------------------------------------------
try
    DCM.M.U = spm_dcm_eeg_channelmodes_T12_CMCperturb(DCM.M.dipfit,Nm);
end
...
%==========================================================================
[Qp,Cp,Eh,F] = spm_nlsi_GN_T12_CMCperturb(DCM.M,DCM.xU,DCM.xY);
...
%--------------------------------------------------------------------------
Hc  = spm_csd_mtf_T12_CMCperturb(Qp,DCM.M,DCM.xU);                      % prediction
...
[Hs ] = spm_csd_mtf_T12_CMCperturb(qp,M,DCM.xU);
